...
public class InputController {
        ...
        public void PollActionLinux(Component comp, float value){
                ...
                //Keyboard Z : Forwards
                else if(comp.toString().equals("W")){  
                        if(value==1.0f){
                                if(keyList.contains("W") == false)keyList.add("W");             //if the key is already part of keyList, don't add it again.
                                if(keyList.contains("A")){                                                              //if left is also being pressed, then set direction as well.
                                        input.jmag = -1;
                                        input.tmag = 1;
                                }else if(keyList.contains("S") == true){                                //if both up and down are pressed, nothing happens
                                        input.tmag = 0;
                ...
                //Keyboard S : Backwards
                        ...
                        if(value==1.0f){
                                ...
                                if(keyList.contains("A")){                                                              //if left is also being pressed, then set direction as well.
                                        input.jmag = -1;
                                        input.tmag = -1;
                                }else if(keyList.contains("W") == true){                                //if both up and down are pressed, nothing happens.
                                        input.tmag = 0;
                                }else if(keyList.contains("D")){                                                //if right is also being pressed, then set direction as well.
                                        input.jmag = 1;
                                        input.tmag = -1;
                                ...
                                if(keyList.contains("W") == false && keyList.contains("S") == false){   //if no up/down keys are pressed, reset all values.
                                        ...
                                        input.tmag = 0;
                                        updateSpeeds();
                                }else if(keyList.contains("W") == true){                                                                //if up key is pressed when down is released, go forwards.
                                        input.jmag = 0;
                                        input.tmag = 1;
                                        updateSpeeds();
                                }
                ...
                //Keyboard Q : Left
                        ...
                        if(value==1.0f){
                                if(keyList.contains("A") == false)keyList.add("A");             //if the key is already part of keyList, don't add it again.
                                input.jmag = -1;
                                if(keyList.contains("W")){                                                              //if up is also being pressed, then set this as well.
                                        input.tmag = 1;
                                }else if(keyList.contains("S")){                                                //if down is also being pressed, then set this as well.
                                        input.tmag = -1;
                                }else{
                                ...
                                if(keyList.contains("W") == false && keyList.contains("S") == false){   //if no up/down keys are pressed, reset all values.
                                        ...
                                        input.tmag = 0;
                                        updateSpeeds();
                                }else if(keyList.contains("W") == true){                                                                //if up key is still pressed and left released, go forward.
                                        input.jmag = 0;
                                        input.tmag = 1;
                                        updateSpeeds();
                                }else{                                                                                                                                  //if down key is still pressed and left released, go backward.
